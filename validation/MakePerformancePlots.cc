...
void MakePerformancePlots(const std::string &filename1, const std::string &filename2, const std::string &filename3, const std::string &legend1, const std::string &legend2, const std::string &legend3)
{
    TFile *file_v0 = new TFile(filename1.c_str());
    TFile *file_v1 = new TFile(filename2.c_str());
    TFile *file_v2 = new TFile(filename3.c_str());

    vector<TFile*> filesVector;
    filesVector.emplace_back(file_v0);
    filesVector.emplace_back(file_v1);
    filesVector.emplace_back(file_v2);
    ...
    legendName.emplace_back(legend3);
